...
function pickWordByDifficulty (type) {
    ...
    if (d === 2) {
        return CommonWords[J.random(0, CommonWords.length - 1)];
    }
    return singleWord[type][J.random(0, singleWord[type].length - 1)];
}
